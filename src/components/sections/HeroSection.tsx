  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden z-0">
        ...
        <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-accent/20 rounded-full blur-[120px]"></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-secondary/10 rounded-full blur-[150px]"></div>
      </div>
      
      <div className="container-custom relative z-10 py-16 lg:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-left animate-fade-in">
            <div className="inline-block px-4 py-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-full text-foreground mb-6 animate-slide-up">
          ...
          <div className={cn(
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl transform rotate-6 hover:rotate-0 transition-all duration-500">
              <div className="absolute inset-0 bg-gradient-to-r from-primary/20 to-secondary/20 mix-blend-overlay backdrop-blur-sm"></div>
              <img 
      ...
      <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 flex flex-col items-center animate-pulse">
        <span className="text-sm mb-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20">
          ស្វែងយល់បន្ថែម
        </span>
        <div className="w-6 h-10 border-2 border-foreground/30 rounded-full flex items-start justify-center p-1 bg-white/10 backdrop-blur-sm">
          <div className="w-1 h-2 bg-foreground/50 rounded-full animate-[bounce_1.5s_infinite]"></div>
        </div>
      </div>
    </section>
  );
